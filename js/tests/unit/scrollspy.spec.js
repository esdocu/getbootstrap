  ...
  describe('constructor', () => {
    ...
    it('should not process element without target', () => {
      fixtureEl.innerHTML = [
        ...
        '  <ul class="navbar-nav">',
        '    <li class="nav-item"><a class="nav-link active" id="one-link" href="#">Uno</a></li>',
        '    <li class="nav-item"><a class="nav-link" id="two-link" href="#two">Dos</a></li>',
        '    <li class="nav-item"><a class="nav-link" id="three-link" href="#three">Tres</a></li>',
        '  </ul>',
        '</nav>',
    ...
    it('should correctly select middle navigation option when large offset is used', done => {
      fixtureEl.innerHTML = [
        ...
        '<nav id="navigation" class="navbar">',
        '  <ul class="navbar-nav">',
        '    <li class="nav-item"><a class="nav-link active" id="one-link" href="#one">Uno</a></li>',
        '    <li class="nav-item"><a class="nav-link" id="two-link" href="#two">Dos</a></li>',
        '    <li class="nav-item"><a class="nav-link" id="three-link" href="#three">Tres</a></li>',
        '  </ul>',
        '</nav>',
    ...
    it('should clear selection if above the first section', done => {
      fixtureEl.innerHTML = [
        ...
        '<nav id="navigation" class="navbar">',
        '  <ul class="navbar-nav">',
        '    <li class="nav-item"><a id="one-link"   class="nav-link active" href="#one">Uno</a></li>',
        '    <li class="nav-item"><a id="two-link"   class="nav-link" href="#two">Dos</a></li>',
        '    <li class="nav-item"><a id="three-link" class="nav-link" href="#three">Tres</a></li>',
        '  </ul>',
        '</nav>',
        '<div id="content" style="height: 200px; overflow-y: auto;">',
